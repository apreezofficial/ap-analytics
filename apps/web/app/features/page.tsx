...
export default function FeaturesPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#07090f] text-white font-dm overflow-x-hidden star-bg antialiased">
      ...
      <main>
        {/* ── HERO ── */}
        <section className="relative z-10 flex flex-col items-center text-center px-6 pt-20 pb-24 overflow-hidden">
          {/* glow orbs */}
          ...
          <TypingTitle 
            className="font-sora font-bold leading-[1.05] tracking-tight mt-8 mb-6 relative z-10 min-h-[160px] [text-wrap:balance]"
          ...
          <p className="text-[#8892a4] leading-relaxed max-w-lg font-light text-[1rem] relative z-10 opacity-0 [animation:fadeup_0.9s_cubic-bezier(.22,1,.36,1)_2.8s_forwards] [text-wrap:balance]">
          ...
          <div className="flex flex-wrap gap-4 mt-10 justify-center relative z-10 opacity-0 [animation:fadeup_0.9s_cubic-bezier(.22,1,.36,1)_3.1s_forwards]">
            <Link
              href="/register"
